...
- [commitment/roles-over-model-names] 설계 단위는 main·orchestrator·implementer·clerk·verifier·reviewer의 책임이고 모델은 profile이 binding한다. 구독이나 모델 세대가 바뀌면 binding만 바뀌어야 하며 workflow를 재설계하게 해서는 안 된다.

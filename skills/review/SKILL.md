...
*finding triage skeleton*: if the reply has `WS-GPT-NNN` finding blocks it builds a table, else it
...
If ingest parsed a `WS-GPT-NNN` triage-skeleton table, prepare the complete replacement triage
